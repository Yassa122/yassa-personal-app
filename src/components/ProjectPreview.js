...
const ProjectPreview = ({ imageUrl, projectLink, title, description }) => (
  <a href={projectLink} target="_blank" rel="noopener noreferrer" className="project-preview block my-4">
    <div className="project-container border border-lightWhite rounded-md overflow-hidden">
      <div className="p-4 project-description" style={{ backgroundColor: 'transparent' }}>
